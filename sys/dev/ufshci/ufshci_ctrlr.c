...
#define UFSHCI_QCOM_QMP_PHY_V6_PCS_UFS_POWER_DOWN_CONTROL 0x004
#define UFSHCI_QCOM_QMP_PHY_V6_PCS_UFS_SW_RESET 0x008
#define UFSHCI_QCOM_QMP_PHY_V6_PCS_UFS_PHY_START 0x000
#define UFSHCI_QCOM_QMP_PHY_V6_PCS_UFS_PLL_CNTL 0x02c
#define UFSHCI_QCOM_QMP_PHY_V6_PCS_UFS_TX_HSGEAR_CAPABILITY 0x074
#define UFSHCI_QCOM_QMP_PHY_V6_PCS_UFS_RX_HSGEAR_CAPABILITY 0x0bc
#define UFSHCI_QCOM_QMP_PHY_V6_PCS_UFS_READY_STATUS 0x1a8
#define UFSHCI_QCOM_QMP_PHY_V6_PCS_UFS_RX_SIGDET_CTRL2 0x18c
#define UFSHCI_QCOM_QMP_PHY_V6_PCS_UFS_TX_LARGE_AMP_DRV_LVL 0x030
...
#define UFSHCI_QCOM_QSERDES_UFS_V6_TX_RES_CODE_LANE_OFFSET_TX 0x030
#define UFSHCI_QCOM_QSERDES_UFS_V6_TX_LANE_MODE_1 0x07c
#define UFSHCI_QCOM_QSERDES_UFS_V6_TX_FR_DCC_CTRL 0x108
